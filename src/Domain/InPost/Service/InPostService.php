...
namespace App\Domain\InPost\Service;

use App\Domain\Courier\Service\AbstractCourierService;
use App\Domain\Courier\Contracts\CourierIntegrationInterface;
use App\Domain\InPost\Contracts\InPostServiceInterface;
use App\Domain\InPost\DTO\InPostShipmentRequestDTO;
use App\Domain\InPost\DTO\InPostShipmentResponseDTO;
use App\Domain\InPost\DTO\LockerDetailsDTO;
...
use App\Domain\InPost\Enum\InPostStatus;
use App\Domain\InPost\Enum\ParcelSize;
...
class InPostService extends AbstractCourierService implements CourierIntegrationInterface, InPostServiceInterface
{
    ...
    {
        // Implement webhook processing for status updates
        ...
        // Here you would typically update your local shipment status
        // This would be handled by an event system or direct database update
